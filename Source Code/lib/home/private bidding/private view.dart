...
class privateproductview extends StatefulWidget {
  final Product product;
  final roomId;
  privateproductview({required this.product,super.key, this.roomId});


  @override
  State<privateproductview> createState() => _privateproductviewState();
}

class _privateproductviewState extends State<privateproductview> {
